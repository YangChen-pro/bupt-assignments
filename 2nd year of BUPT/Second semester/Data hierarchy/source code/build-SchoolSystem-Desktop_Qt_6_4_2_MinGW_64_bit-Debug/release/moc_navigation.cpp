...
#include <memory>
#include "../../SchoolSystem/navigation.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_Navigation_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_Navigation_t qt_meta_stringdata_Navigation = {
    {
        QT_MOC_LITERAL(0, 10)   // "Navigation"
    },
    "Navigation"
};
...
Q_CONSTINIT static const uint qt_meta_data_Navigation[] = {
...
Q_CONSTINIT const QMetaObject Navigation::staticMetaObject = { {
    ...
    qt_meta_stringdata_Navigation.offsetsAndSizes,
    qt_meta_data_Navigation,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_Navigation_t,
        // Q_OBJECT / Q_GADGET
